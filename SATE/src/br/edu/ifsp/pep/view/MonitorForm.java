 ...
 * @author Aluno
 */
public class MonitorForm extends javax.swing.JDialog {
    ...
    public void setMonitor(Monitor monitor) {
        ...
        formatNumRegistro.setText(monitor.getNumeroRegistro());
        formatNumRegistro.setEnabled(false);
        txtNome.setText(monitor.getNomeFuncionario());
        CSexo.setSelectedItem(monitor.getSexo());
        txtCpf.setText(monitor.getCpf());
        formatDataNascimento.setText(Conversoes.getDateFormatedToString(monitor.getDataNascimento()));
        txtNaturalidade.setText(monitor.getNaturalidade());
        txtNomePai.setText(monitor.getNomePai());
        txtNomeMae.setText(monitor.getNomeMae());
        
        CEscolaridade.setSelectedItem(monitor.getEscolaridade());
        CEstadoCivil.setSelectedItem(monitor.getEstadoCivil());
        
        txtEmail.setText(monitor.getEmail());
        txtEndereco.setText(monitor.getEndereco());
        txtSalarioBase.setText(String.valueOf(monitor.getSalarioBase()));
        if(monitor.isStatus() == true){
            CStatus.setSelectedIndex(0);
        }else{
            CStatus.setSelectedIndex(1);
        }
        txtNumeroConta.setText(monitor.getNumeroConta());
        txtRegistroPedagogico.setText(monitor.getRegistroPedagogico());     
    }
    
    public MonitorForm(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        txtRegistroPedagogico = new javax.swing.JTextField();
        ...
        jLabel5.setText("Cadastro Monitor");
        ...
        jPanel2.add(pCancelar, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 530, 140, 30));
        ...
        jPanel2.add(pSalvar, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 530, 150, 30));
        ...
        jLabel26.setText("Registro pedagógico:");
        jPanel2.add(jLabel26, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 340, -1, -1));
        jPanel2.add(txtRegistroPedagogico, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 360, 200, -1));
    ...
    private void pCancelarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_pCancelarMouseClicked
        // TODO add your handling code here:
        //RecursosHumanosMonitor tela = new RecursosHumanosMonitor(null, false);
    ...
    private void pSalvarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_pSalvarMouseClicked
        ...
        if (txtRegistroPedagogico.getText().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Preencha o campo Registro pedagógico!");
            txtRegistroPedagogico.requestFocus();
            return;
        }


        monitor.setNumeroRegistro(formatNumRegistro.getText());
        monitor.setNomeFuncionario(txtNome.getText());
        monitor.setCpf(txtCpf.getText());
        monitor.setDataNascimento(Conversoes.getDateOfString(formatDataNascimento.getText()));
        monitor.setNaturalidade(txtNaturalidade.getText());
        monitor.setNomePai(txtNomePai.getText());
        monitor.setNomeMae(txtNomeMae.getText());
        monitor.setEmail(txtEmail.getText());
        monitor.setEndereco(txtEndereco.getText());
        monitor.setSalarioBase(Double.parseDouble(txtSalarioBase.getText()));
        monitor.setNumeroConta(txtNumeroConta.getText());
        monitor.setRegistroPedagogico(txtRegistroPedagogico.getText());

        monitor.setStatus(true);
        monitor.setEscolaridade(CEscolaridade.getSelectedItem().toString());
        monitor.setEstadoCivil(CEstadoCivil.getSelectedItem().toString());
        monitor.setSexo(CSexo.getSelectedItem().toString());

        if(this.monitor==null){
            try {
                controle.inserir(monitor);
                JOptionPane.showMessageDialog(null, "Monitor cadastrado com sucesso!");
            } catch (Exception ex) {
                JOptionPane.showMessageDialog(this, "Erro inesperado ao inserir monitor!");
            }
        }else{
            monitor.setNumeroRegistro(this.monitor.getNumeroRegistro());
            try {
                controle.alterar(monitor);
                JOptionPane.showMessageDialog(null, "Monitor alterado com sucesso!");
            } catch (Exception ex) {
                JOptionPane.showMessageDialog(null, "Erro ao alterar monitor!");
            }
        }
        //RecursosHumanosMonitor tela = new RecursosHumanosMonitor(null, false);
        //tela.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MonitorForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MonitorForm dialog = new MonitorForm(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JTextField txtRegistroPedagogico;
