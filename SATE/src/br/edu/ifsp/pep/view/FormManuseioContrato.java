 ...
 * @author Aluno
 */
public class FormManuseioContrato extends javax.swing.JDialog {
    ...
    public FormManuseioContrato(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        PParcelas = new javax.swing.JPanel();
        ...
        PParcelas.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                PParcelasMouseClicked(evt);
            }
        });
        ...
        javax.swing.GroupLayout PParcelasLayout = new javax.swing.GroupLayout(PParcelas);
        PParcelas.setLayout(PParcelasLayout);
        PParcelasLayout.setHorizontalGroup(
            PParcelasLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(PParcelasLayout.createSequentialGroup()
                .addGap(91, 91, 91)
                .addComponent(jLabel3)
                .addContainerGap(99, Short.MAX_VALUE))
        );
        PParcelasLayout.setVerticalGroup(
            PParcelasLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(PParcelasLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jLabel3)
        ...
        PMenu.add(PParcelas, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 300, 250, 40));
        ...
        tContrato.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id Contrato", "Inicio", "Fim", "Valor", "Nome Crianca"
            }
        ) {
        ...
        tContrato.getTableHeader().setReorderingAllowed(false);
    ...
    private void PCadastrarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_PCadastrarMouseClicked
        ...
        ContratoForm tela = new ContratoForm(null, true);
        tela.setVisible(true);
        botPesquisarMouseClicked(evt);
        //this.dispose();
    }//GEN-LAST:event_PCadastrarMouseClicked

    private void PParcelasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_PParcelasMouseClicked

        int linha = tContrato.getSelectedRow();
        Integer idContrato = 0;
        ControleContrato controle = new ControleContrato();
        if(linha != -1){        
             for(int i=0; i<5; i++){
                if(tContrato.getColumnName(i).equals("Id Contrato")){
                    idContrato = Integer.parseInt(tContrato.getValueAt(linha, i).toString());
                }               
            }  
            
            contratoSelecionado = controle.findByNumContrato(idContrato);
            ContratoParcelas tela = new ContratoParcelas(null, true);
            tela.setContrato(contratoSelecionado);
            tela.setVisible(true);
        }else{
            JOptionPane.showMessageDialog(this, "selecione um contrato!");
        }
    }//GEN-LAST:event_PParcelasMouseClicked
    ...
    private void botPesquisarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_botPesquisarMouseClicked
        ...
        DefaultTableModel model = (DefaultTableModel) tContrato.getModel();
        model.setNumRows(0);
        list = controle.findByCriancaNome(txtPesquisar.getText().toString());
        for(Contrato c: list){
            model.addRow(new Object[] {c.getNumContrato(), Conversoes.getDateFormatedToString(c.getDataInicio()), Conversoes.getDateFormatedToString(c.getDataFim()), c.getValorContrato(), c.getCrianca().getNome()});
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormManuseioContrato.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormManuseioContrato dialog = new FormManuseioContrato(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JPanel PParcelas;
